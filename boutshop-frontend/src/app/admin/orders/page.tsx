...
export default function AdminOrdersPage() {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Commandes ({total})</CardTitle>
        <CardDescription>Toutes les commandes de la plateforme, plus récentes en premier.</CardDescription>
      </CardHeader>
      <CardContent>
        {loading ? (
              ...
              <tbody>
                {orders.map((o) => (
                  <tr key={o._id} className="border-b border-border/30 hover:bg-muted/20">
                    ...
                    <td className="py-3 text-right font-bold">{fmt(o.total, o.currency)}</td>
                    <td className="py-3">
