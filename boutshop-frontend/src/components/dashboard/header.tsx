...
import { Bell, ExternalLink, LogOut, Menu, Search, Settings as SettingsIcon, User } from 'lucide-react';
      ...
      <div className="flex items-center gap-1.5">
        ...
        >
          ...
          <span className="absolute right-2.5 top-2.5 flex h-2 w-2">
            ...
            <span className="relative inline-flex h-2 w-2 rounded-full gradient-brand" />
          </span>
        </button>
