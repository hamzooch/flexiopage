...
const DICT: Record<StorefrontLocale, Dictionary> = {
  ...
  es: {
    ...
    'nav.merchant':          'Área del vendedor',
    'product.outOfStock':    'Agotado',
    'product.inStock':       'En stock',
    'product.discover':      'Descubrir',
    'product.learnMore':     'Saber más',
    'product.viewProduct':   'Ver producto',
    'product.relatedTitle':  'También te puede gustar',
    'cod.headline':          'Pedir · Pago contra reembolso',
    'cod.submit':            'Hacer pedido',
    'cod.reassurance':       'Sin pago anticipado, paga al recibir el pedido',
    'cod.payAtDelivery':     'A pagar al recibir',
    'cod.subtotal':          'Subtotal',
    'cod.shipping':          'Envío',
    'cod.fullName':          'Nombre completo *',
    'cod.phone':             'Teléfono *',
    'cod.email':             'Correo electrónico',
    'cod.country':           'País *',
    'cod.address':           'Dirección *',
    'cod.addressExtra':      'Complemento (opcional)',
    'cod.city':              'Ciudad *',
    'cod.state':             'Provincia',
    'cod.postalCode':        'Código postal',
    'cod.notes':             'Nota para el repartidor (opcional)',
    'cod.havePromo':         'Tengo un código promocional',
    'cod.applyPromo':        'Aplicar',
    'cod.cancel':            'Cancelar',
    'cod.quantity':          'Cantidad',
    'footer.allRights':      'Todos los derechos reservados.',
    'common.required':       'Obligatorio',
    'wishlist.empty':        'No hay favoritos',
  ...
  it: {
    ...
    'nav.merchant':          'Area venditore',
    'product.outOfStock':    'Esaurito',
    'product.inStock':       'Disponibile',
    'product.discover':      'Scopri',
    'product.learnMore':     'Scopri di più',
    'product.viewProduct':   'Vedi prodotto',
    'product.relatedTitle':  'Potrebbe piacerti anche',
    'cod.headline':          'Ordina · Pagamento alla consegna',
    'cod.submit':            'Ordina ora',
    'cod.reassurance':       'Nessun anticipo, paghi solo alla consegna',
    'cod.payAtDelivery':     'Da pagare alla consegna',
    'cod.subtotal':          'Subtotale',
    'cod.shipping':          'Spedizione',
    'cod.fullName':          'Nome completo *',
    'cod.phone':             'Telefono *',
    'cod.email':             'Email',
    'cod.country':           'Paese *',
    'cod.address':           'Indirizzo *',
    'cod.addressExtra':      'Complemento (facoltativo)',
    'cod.city':              'Città *',
    'cod.state':             'Provincia',
    'cod.postalCode':        'CAP',
    'cod.notes':             'Nota per il corriere (facoltativo)',
    'cod.havePromo':         'Ho un codice sconto',
    'cod.applyPromo':        'Applica',
    'cod.cancel':            'Annulla',
    'cod.quantity':          'Quantità',
    'footer.allRights':      'Tutti i diritti riservati.',
    'common.required':       'Obbligatorio',
    'wishlist.empty':        'Nessun preferito',
...
// renders blank. Permet de livrer ES + IT complets (couverts au-dessus)
// tout en gardant pt + de en placeholder anglais — à traduire quand on
// ouvre ces marchés.
for (const loc of (['pt', 'de'] as const)) {
  DICT[loc] = { ...DICT.en };
}
