/**
 * Country → currency map used by the profile and store creation flows.
 * Mirrors flexiopage-backend/src/data/countries.ts — keep in sync.
 */
...
export const COUNTRY_GROUPS: { id: CountryInfo['group']; label: string }[] = [
  { id: 'arab',     label: 'Monde arabe' },
