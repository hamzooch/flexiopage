 ...
 *
 *   - 1 seller (test-seller@flexiopage.dev / Test1234!)
 ...
 *     address. webhookSecret comes from FLEXIOPAGE_WEBHOOK_SECRET (env) — the
 *     same value MogaDelivery uses to verify our X-Flexiopage-Signature.
 ...
 *
 * Run:
 *   cd flexiopage-backend && npm run seed:test-store
 *
 * After seeding:
...
const SELLER_EMAIL = 'test-seller@flexiopage.dev';
